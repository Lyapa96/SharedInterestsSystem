...
class Node(object):
    ...
    def release(self, next_individual_index, next_node, current_time):
        ...
        next_individual_server = False
        if not isinf(self.c):
            next_individual_server = next_individual.server
            self.detatch_server(next_individual.server, next_individual)
        self.write_individual_record(next_individual, next_individual_server)
    ...
    def write_individual_record(self, individual, server=False):
        """
